function [im_seg, im_patch, label_full] = segmentPatch(im, im_depth, im_edge, edge_group, patch_coord, active_mask)
	...
	energy_color = energy_color(patch_coord(1):patch_coord(2), patch_coord(3):patch_coord(4));
