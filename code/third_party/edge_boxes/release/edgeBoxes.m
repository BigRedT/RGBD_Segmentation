function [bbs, E, V] = edgeBoxes( I, model, varargin )
...
if(~iscell(I)), [bbs, E, V] =edgeBoxesImg(I,model,o); else n=length(I);
  bbs=cell(n,1); E = cell(n, 1); parfor i=1:n, [bbs{i}, E{i}, V{i}] = edgeBoxesImg(I{i},model,o); end; end
d=fileparts(f); if(~isempty(d)&&~exist(d,'dir')), mkdir(d); end
if(~isempty(f)), save(f,'bbs'); bbs=1; end

end

function [bbs, E, V] = edgeBoxesImg( I, model, o )
...
[bbs, V] =edgeBoxesMex(E,O,o.alpha,o.beta,o.minScore,o.maxBoxes,...
